...
const HeroSection = () => {
    ...
    return (
        <section id="home" className="py-30 md:py-40 bg-[var(--black-color)] min-h-screen">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-row justify-center items-center gap-4">
                            <button
                                ...
                                className="text-sm px-4 py-2 bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] text-white rounded-lg transition-all duration-300 font-medium flex items-center justify-center gap-1 shadow-lg cursor-pointer"
                            >
                                {/* <Code size={18} /> */}
                                Explore Projects
                            </button>
                            <button
                                ...
                                className="text-sm px-4 py-2 bg-[var(--card-color)] border border-[var(--border-color)] text-[var(--white-color)] rounded-lg transition-all duration-300 font-medium flex items-center justify-center gap-1 cursor-pointer"
                            >
